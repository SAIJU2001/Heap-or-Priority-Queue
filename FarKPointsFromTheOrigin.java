//calculate the distance of all co-ordinates and find maximum
...
public class FarKPointsFromTheOrigin 
{
    public static void main(String args[])
    {
        ...
        System.out.println("far from the origin k points are : ");
        while( k-->0 )
        {
            //print the far points
